...
/**
 * @deprecated Kept for backwards-compatibility with legacy rows.
 * New products should be entered as separate SKUs per configuration
 * (each with its own brand + model + specifications).
 */
